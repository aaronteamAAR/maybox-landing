      ...
      <section className="sect1 relative pt-5 md:ml-0 ml-1">
        <div className="w-full h-screen relative overflow-hidden">
          <img
            src={heroimg}
            alt="Hero image"
            className="w-full hero h-full object-cover rounded-[14px] md:rounded-3xl"
          />
          <div className="absolute inset-0 rounded-0 md:rounded-3xl bg-opacity-30 " /> 

          {/* Added a div with opacity to darken and give the background image some aesthetics and for the div in front of it, emphasis */}

          <div className="absolute bottom-10 left-4 md:bottom-28 md:left-8 z-10 md:w-full w-96 bg-[#f2efe9] p-4 md:p-8 max-w-md">
